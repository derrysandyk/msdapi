...
def cache_it(limit=100000, expire=DEFAULT_EXPIRY, cache=None,
...
my_cache = SimpleCache(limit=10000, expire=60 * 60, hashkeys=True, host=os.environ.get('REDIS_HOST', 'localhost'),
                       port=os.environ.get('REDIS_PORT', 6379), db=1)
